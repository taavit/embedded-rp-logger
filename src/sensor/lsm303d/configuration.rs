...
impl Default for Configuration {
    fn default() -> Self {
        Self {
            ...
            temperature: InternalTemperatureConfiguration {
                active: false,
            }
        }
    }
...
impl Configuration {
    pub fn configure_accelerometer(mut self, axis_x: bool, axis_y: bool, axis_z: bool, data_rate: AccelerationDataRate, scale: AccelerationFullScale) -> Self {
    ...
    pub fn as_ctrl1(&self) -> u8 {
        let mut ctrl1 = 0;
        ctrl1 |= if self.accelerometer.axis_x { 0b0000_0001 } else { 0b0000_0000 };
        ctrl1 |= if self.accelerometer.axis_y { 0b0000_0010 } else { 0b0000_0000 };
        ctrl1 |= if self.accelerometer.axis_z { 0b0000_0100 } else { 0b0000_0000 };
    ...
    pub fn as_ctrl5(&self) -> u8 {
        ...
        ctrl5 |= if self.temperature.active { 0b1000_0000 } else { 0b0000_0000 };
